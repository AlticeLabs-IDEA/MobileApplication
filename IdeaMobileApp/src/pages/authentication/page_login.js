...
import { Pressable, ScrollView, ImageBackground, Image, Text, Modal, View, TextInput, Alert, BackHandler } from "react-native";
...
export default function LoginScreen({ navigation }) {
    ...
    return (
        <View style={[styles.mainContainer, { height: CONST.screenHeight + CONST.layoutPaddingVertical / 2, paddingTop: 0, paddingBottom: 0 }]}>
